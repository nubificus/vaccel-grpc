...
impl ::protobuf::Message for CreateCaffeModelRequest {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if !self.prototxt.is_empty() {
            my_size += ::protobuf::rt::bytes_size(1, &self.prototxt);
        }
        if !self.binary_model.is_empty() {
            my_size += ::protobuf::rt::bytes_size(2, &self.binary_model);
        }
        if !self.labels.is_empty() {
            my_size += ::protobuf::rt::bytes_size(3, &self.labels);
        }
        my_size += ::protobuf::rt::unknown_fields_size(self.special_fields.unknown_fields());
        self.special_fields.cached_size().set(my_size as u32);
        my_size
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if !self.prototxt.is_empty() {
            os.write_bytes(1, &self.prototxt)?;
        }
        if !self.binary_model.is_empty() {
            os.write_bytes(2, &self.binary_model)?;
        }
        if !self.labels.is_empty() {
            os.write_bytes(3, &self.labels)?;
        }
        os.write_unknown_fields(self.special_fields.unknown_fields())?;
        ::std::result::Result::Ok(())
    }
...
impl CreateResourceRequest {
    ...
    // .vaccel.CreateSharedObjRequest shared_obj = 1;
    ...
    // .vaccel.CreateSingleModelRequest single_model = 2;
    ...
    // .vaccel.CreateTensorflowSavedModelRequest tf_saved_model = 3;
    ...
    // .vaccel.CreateCaffeModelRequest caffe_model = 4;
...
// @@protoc_insertion_point(message:vaccel.SetResourceDepsRequest)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct SetResourceDepsRequest {
    // message fields
    // @@protoc_insertion_point(field:vaccel.SetResourceDepsRequest.resource_id)
    pub resource_id: i64,
    // @@protoc_insertion_point(field:vaccel.SetResourceDepsRequest.deps)
    pub deps: ::std::vec::Vec<i64>,
    // special fields
    // @@protoc_insertion_point(special_field:vaccel.SetResourceDepsRequest.special_fields)
    pub special_fields: ::protobuf::SpecialFields,
}

impl<'a> ::std::default::Default for &'a SetResourceDepsRequest {
    fn default() -> &'a SetResourceDepsRequest {
        <SetResourceDepsRequest as ::protobuf::Message>::default_instance()
    }
}

impl SetResourceDepsRequest {
    pub fn new() -> SetResourceDepsRequest {
        ::std::default::Default::default()
    }
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "resource_id",
            |m: &SetResourceDepsRequest| { &m.resource_id },
            |m: &mut SetResourceDepsRequest| { &mut m.resource_id },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_vec_simpler_accessor::<_, _>(
            "deps",
            |m: &SetResourceDepsRequest| { &m.deps },
            |m: &mut SetResourceDepsRequest| { &mut m.deps },
        ));
        ::protobuf::reflect::GeneratedMessageDescriptorData::new_2::<SetResourceDepsRequest>(
            "SetResourceDepsRequest",
            fields,
            oneofs,
        )
    }
...
impl ::protobuf::Message for SetResourceDepsRequest {
    const NAME: &'static str = "SetResourceDepsRequest";
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                18 => {
                    is.read_repeated_packed_int64_into(&mut self.deps)?;
                },
                16 => {
                    self.deps.push(is.read_int64()?);
                },
                tag => {
                    ::protobuf::rt::read_unknown_or_skip_group(tag, is, self.special_fields.mut_unknown_fields())?;
                },
    ...
    fn new() -> SetResourceDepsRequest {
        SetResourceDepsRequest::new()
    }
    ...
    fn default_instance() -> &'static SetResourceDepsRequest {
        static instance: SetResourceDepsRequest = SetResourceDepsRequest {
            resource_id: 0,
...
impl ::protobuf::MessageFull for SetResourceDepsRequest {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("SetResourceDepsRequest").unwrap()).clone()
    }
}

impl ::std::fmt::Display for SetResourceDepsRequest {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for SetResourceDepsRequest {
    type RuntimeType = ::protobuf::reflect::rt::RuntimeTypeMessage<Self>;
}
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    odelRequest\x12\x1a\n\x08prototxt\x18\x01\x20\x01(\x0cR\x08prototxt\x12!\
    \n\x0cbinary_model\x18\x02\x20\x01(\x0cR\x0bbinaryModel\x12\x16\n\x06lab\
    els\x18\x03\x20\x01(\x0cR\x06labels\"\xc2\x02\n\x15CreateResourceRequest\
    \x12?\n\nshared_obj\x18\x01\x20\x01(\x0b2\x1e.vaccel.CreateSharedObjRequ\
    estH\0R\tsharedObj\x12E\n\x0csingle_model\x18\x02\x20\x01(\x0b2\x20.vacc\
    el.CreateSingleModelRequestH\0R\x0bsingleModel\x12Q\n\x0etf_saved_model\
    \x18\x03\x20\x01(\x0b2).vaccel.CreateTensorflowSavedModelRequestH\0R\x0c\
    tfSavedModel\x12B\n\x0bcaffe_model\x18\x04\x20\x01(\x0b2\x1f.vaccel.Crea\
    ...
    d\"M\n\x16SetResourceDepsRequest\x12\x1f\n\x0bresource_id\x18\x01\x20\
    \x01(\x03R\nresourceId\x12\x12\n\x04deps\x18\x02\x20\x03(\x03R\x04deps\"\
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            messages.push(SetResourceDepsRequest::generated_message_descriptor_data());
