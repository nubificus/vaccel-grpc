...
//! Generated file from `sync/agent.proto`
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \n\x0fSetResourceDeps\x12\x1e.vaccel.SetResourceDepsRequest\x1a\x13.vacc\
    el.VaccelEmpty\x12F\n\x0fDestroyResource\x12\x1e.vaccel.DestroyResourceR\
    equest\x1a\x13.vaccel.VaccelEmpty\x12^\n\x13ImageClassification\x12\".va\
    ccel.ImageClassificationRequest\x1a#.vaccel.ImageClassificationResponse\
    \x12^\n\x13TensorflowModelLoad\x12\".vaccel.TensorflowModelLoadRequest\
    \x1a#.vaccel.TensorflowModelLoadResponse\x12d\n\x15TensorflowModelUnload\
    \x12$.vaccel.TensorflowModelUnloadRequest\x1a%.vaccel.TensorflowModelUnl\
    oadResponse\x12[\n\x12TensorflowModelRun\x12!.vaccel.TensorflowModelRunR\
    equest\x1a\".vaccel.TensorflowModelRunResponse\x12j\n\x17TensorflowLiteM\
    odelLoad\x12&.vaccel.TensorflowLiteModelLoadRequest\x1a'.vaccel.Tensorfl\
    owLiteModelLoadResponse\x12p\n\x19TensorflowLiteModelUnload\x12(.vaccel.\
    TensorflowLiteModelUnloadRequest\x1a).vaccel.TensorflowLiteModelUnloadRe\
    sponse\x12g\n\x16TensorflowLiteModelRun\x12%.vaccel.TensorflowLiteModelR\
    unRequest\x1a&.vaccel.TensorflowLiteModelRunResponse\x12^\n\x13TorchJitl\
    oadForward\x12\".vaccel.TorchJitloadForwardRequest\x1a#.vaccel.TorchJitl\
    oadForwardResponse\x124\n\x05Genop\x12\x14.vaccel.GenopRequest\x1a\x15.v\
    accel.GenopResponse\x12@\n\tGetTimers\x12\x18.vaccel.ProfilingRequest\
    \x1a\x19.vaccel.ProfilingResponseb\x06proto3\
";
