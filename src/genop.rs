...
impl ::protobuf::Message for GenopArg {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        if self.size != 0 {
            my_size += ::protobuf::rt::uint32_size(1, self.size);
        }
        if !self.buf.is_empty() {
            my_size += ::protobuf::rt::bytes_size(2, &self.buf);
        }
        if self.parts != 0 {
            my_size += ::protobuf::rt::uint32_size(3, self.parts);
        }
        if self.part_no != 0 {
            my_size += ::protobuf::rt::uint32_size(4, self.part_no);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.parts != 0 {
            os.write_uint32(3, self.parts)?;
        }
        if self.part_no != 0 {
            os.write_uint32(4, self.part_no)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x0bgenop.proto\x12\x06vaccel\x1a\x0berror.proto\"_\n\x08GenopArg\x12\
    \x12\n\x04size\x18\x01\x20\x01(\rR\x04size\x12\x10\n\x03buf\x18\x02\x20\
    \x01(\x0cR\x03buf\x12\x14\n\x05parts\x18\x03\x20\x01(\rR\x05parts\x12\
    \x17\n\x07part_no\x18\x04\x20\x01(\rR\x06partNo\"\x8d\x01\n\x0cGenopRequ\
    est\x12\x1d\n\nsession_id\x18\x01\x20\x01(\rR\tsessionId\x12-\n\tread_ar\
    gs\x18\x02\x20\x03(\x0b2\x10.vaccel.GenopArgR\x08readArgs\x12/\n\nwrite_\
    args\x18\x03\x20\x03(\x0b2\x10.vaccel.GenopArgR\twriteArgs\">\n\x0bGenop\
    Result\x12/\n\nwrite_args\x18\x01\x20\x03(\x0b2\x10.vaccel.GenopArgR\twr\
    iteArgs\"u\n\rGenopResponse\x12+\n\x05error\x18\x01\x20\x01(\x0b2\x13.va\
    ccel.VaccelErrorH\0R\x05error\x12-\n\x06result\x18\x02\x20\x01(\x0b2\x13\
    .vaccel.GenopResultH\0R\x06resultB\x08\n\x06resultb\x06proto3\
";
