...
fn main() {
    ...
    let mut libf_async = File::create("src/asynchronous/mod.rs").expect("Could not open crate's async lib file");
    libf_async.write(b"// This is auto-generated by build.rs\n\n#![allow(unused_imports)]\n\n")
        .expect("Could not write in crate's async/mod.rs");
    let mut libf_sync = File::create("src/sync/mod.rs").expect("Could not open crate's sync lib file");
    libf_sync.write(b"// This is auto-generated by build.rs\n\n#![allow(unused_imports)]\n\n")
    ...
    for proto in protos.iter() {
        ...
        libf_async.write_all(&format!("pub use crate::{};\n", mod_name.to_str().unwrap()).as_bytes())
            .expect("Could not write mod in crate's async mod file");
        libf_sync.write_all(&format!("pub use crate::{};\n", mod_name.to_str().unwrap()).as_bytes())
            .expect("Could not write mod in crate's async mod file");
    }
    ...
    for proto in protos_async.iter() {
        ...
        libf_async.write_all(&format!("pub mod {};\n", mod_name.to_str().unwrap()).as_bytes())
            .expect("Could not write mod in crate's async mod file");
    }
